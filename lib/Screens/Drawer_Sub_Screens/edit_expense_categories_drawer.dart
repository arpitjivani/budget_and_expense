...
class EditExpenseCategoriesDrawerScreen extends StatefulWidget {
  final PaintExpense data;
  final String firebaseKey;

  const EditExpenseCategoriesDrawerScreen({
    Key? key,
    required this.data,
  ...
  @override
  _EditExpenseCategoriesDrawerScreenState createState() =>
      _EditExpenseCategoriesDrawerScreenState();
}

class _EditExpenseCategoriesDrawerScreenState
    extends State<EditExpenseCategoriesDrawerScreen> {
  ...
  void initState() {
    ...
    Fluttertoast.showToast(msg: _ref.toString());
  }
