...
//
// class WCategoriesScreen extends StatefulWidget {
//   const WCategoriesScreen({Key? key}) : super(key: key);
//
//   @override
//   _WCategoriesScreenState createState() => _WCategoriesScreenState();
// }
//
// class _WCategoriesScreenState extends State<WCategoriesScreen> {
//   bool selectingmode = false;
//   bool isLoading = false;
//   int _toggleValue = 0;
//   Query? _reference;
//   Query? _referenceIncome;
//
//   String? getUId;
//
...
//           colorPicture1: Color(0xff016BB8).toString(),
//           colorPicture2: Color(0xff11A8FD).toString(),
...
//           title: 'Shopping ',
//           title2: '0 Transaction in 0 Wallet',
//           colorPicture1: Color(0xffD3200C).toString(),
//           colorPicture2: Color(0xffFF5510).toString(),
...
//           title: 'Home ',
//           title2: '0 Transaction in 0 Wallet',
//           colorPicture1: Color(0xffC21FEE).toString(),
//           colorPicture2: Color(0xffF35EA0).toString(),
...
//           title: 'Bills/Fees ',
//           title2: '0 Transaction in 0 Wallet',
//           colorPicture1: Color(0xff1F9C53).toString(),
//           colorPicture2: Color(0xff3EF190).toString(),
...
//           title: 'Entertainment ',
//           title2: '0 Transaction in 0 Wallet',
//           colorPicture1: Color(0xffF06500).toString(),
//           colorPicture2: Color(0xffFFA05C).toString(),
//           icon: "assets/Category_Icon/shopping.png"),
//     },
//     {
//       "": PaintExpense(
//           title: 'Car ',
//           title2: '0 Transaction in 0 Wallet',
//           colorPicture1: Color(0xff89216B).toString(),
//           colorPicture2: Color(0xffDA4453).toString(),
...
//           title2: '0 Transaction in 0 Wallet',
//           colorPicture1: Color(0xff1144FF).toString(),
//           colorPicture2: Color(0xff11A8FD).toString(),
//           icon: "assets/Category_Icon/shopping.png"),
//     },
//     {
...
//         await FirebaseDatabase.instance.ref().child("UserData")
//             .child("$getUId").child("AddNewCategoryExpense");
//
...
//     var firebaseSnapshot =
//         await FirebaseDatabase.instance.ref().child("UserData")
//             .child("$getUId").child("AddNewCategoryIncome");
//
//     firebaseSnapshot.onChildChanged.listen((event) {
//       print("On value changed ${event.snapshot.key}");
