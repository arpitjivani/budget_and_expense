...
class AddCategoriesExpenseDrawerScreen extends StatefulWidget {
  const AddCategoriesExpenseDrawerScreen({
    Key? key,
  }) : super(key: key);

  @override
  _AddCategoriesExpenseDrawerScreenState createState() =>
      _AddCategoriesExpenseDrawerScreenState();
}

class _AddCategoriesExpenseDrawerScreenState
    extends State<AddCategoriesExpenseDrawerScreen> {
