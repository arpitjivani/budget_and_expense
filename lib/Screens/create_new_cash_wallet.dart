...
class CreateNewCashWallet extends StatefulWidget {
  const CreateNewCashWallet({Key? key}) : super(key: key);

  @override
  State<CreateNewCashWallet> createState() => _CreateNewCashWalletState();
}

class _CreateNewCashWalletState extends State<CreateNewCashWallet> {
