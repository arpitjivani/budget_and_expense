...
class _EditCategoriesState extends State<EditCategories> {
  ...
  void getEmailToStorage() async {
    ...
    _amountController =
        TextEditingController(text: widget.categoryData['amount']);
    _noteController = TextEditingController(text: widget.categoryData['note']);
  ...
  //       (await _ref.child(widget.categoryKey).once()) as DataSnapshot;
  //
  //   Map contact = snapshot.value as Map;
  //
  //   _amountController?.text = contact['amount'];
  // }
                                  ...
                                  onTap: () {
                                    showDialog(
                                      ...
                                      builder: (BuildContext context) =>
                                        isDelete?CommonCircularIndicator():  CommonDialog(
                                              title: "Delete Wallet",
                                              subTitle:
  ...
  void saveContact() {
    String? mainCategory = widget.categoryData['categoryName'];
