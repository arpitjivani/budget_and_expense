...
class AddCategoriesExpense extends StatefulWidget {
  final PaintExpense data;

  const AddCategoriesExpense({Key? key, required this.data}) : super(key: key);

  @override
  _AddCategoriesExpenseState createState() => _AddCategoriesExpenseState();
}

class _AddCategoriesExpenseState extends State<AddCategoriesExpense> {
                    ...
                    return Padding(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                  color: Color(0xff1F2427).withOpacity(0.3),
                                  // color: Colors.red.withOpacity(0.8),
                                  blurRadius: 3,
                                  spreadRadius: 0,
                                  offset: Offset(4, 4)),
                              BoxShadow(
                                  color: Color(0xff484E53).withOpacity(0.2),
                                  // color: Colors.yellow.withOpacity(0.6),
                                  blurRadius: 3,
                                  spreadRadius: 0,
                                  offset: Offset(-2, -4)),
